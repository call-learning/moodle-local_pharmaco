...
class tag_scores {
     ...
     *
     * @return array an associative array with the tag rawname and the score as an average percentage scored for this tag
    ...
    public function compute() {
        ...
        foreach ($allquizzesmods as $qmod) {
            ...
            $qubas = $dm->load_questions_usages_by_activity(
                new qubaids_for_users_attempts($qmod->instance, $this->userid));
